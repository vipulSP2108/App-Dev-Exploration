...
const Todo = () => {
  ...
  const rendergotdata = ({ item, index }) => {
    ...
    return (
      <View style={{ ...styles.TextBox, backgroundColor: bgcolor }}>
        <BlurView blurType="light" blurAmount={20}>
  ...
  return (
    <View style={{ flex: 1 }}>
      <Image style={{position:"absolute"}} source={require("./assets/icons/Bg-1.png")}/>
      <View style={{ paddingHorizontal: 12, flexDirection: 'column', flex: 1 }}>
        {
          todo_list.length === 0 ?
            <View>
