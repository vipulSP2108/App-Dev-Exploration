        ...
        return (
            <View style={{ ...styles.TextBox, backgroundColor: bgcolor }}>
                ...
                <TouchableOpacity onPress={() => edit_todo_id(item)}>
                    <Text style={{ color: "green", justifyContent: "center", fontSize: 20, fontWeight: "bold", alignContent: "center", borderWidth: 3, borderRadius: 5, paddingTop: 4, width: 50, paddingLeft: 7 }}>
                        Edit
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => delete_todo_id(item.id)}>
                    <Text style={{ color: "red", fontSize: 20, fontWeight: "bold", borderWidth: 3, borderRadius: 5, width: 80, paddingLeft: 10, paddingTop: 4, marginLeft: 3 }}>
                        Delete
                    </Text>
                </TouchableOpacity>
